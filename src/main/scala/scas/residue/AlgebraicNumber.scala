...
trait AlgebraicNumber[R[C, N] <: PolynomialOverUFD.Element[R[C, N], C, N], C, N] extends Residue[R, C, N] with Field[Element[R, C, N]] { self =>
  val ring: UnivariatePolynomial[R[C, N], C, N]
