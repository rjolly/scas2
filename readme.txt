...
- meditor ( http://github.com/rjolly/meditor/ )
  ...
  jarlister $SCALA_HOME/lib/scala-xml_2.11-1.0.5.jar
  jarlister $SCALA_HOME/lib/scala-parser-combinators_2.11-1.0.4.jar
  jarlister ../meditor/dist/meditor.jar
  jarlister ../meditor/txt2xhtml/dist/txt2xhtml.jar

To build scas:
  sbt package macros/package
  jarlister target/scala-2.11/scas_2.11-2.1.1.jar
